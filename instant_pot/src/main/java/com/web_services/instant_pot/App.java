...
public class App 
{
    public static void main( String[] args )
    {
    	...
    	Product product3 = productLogic.createProduct(partner2, "Product 3", "The third product.", 17.00);
    	Product product4 = productLogic.createProduct(partner2, "Product 4", "The fourth product.", 230.00);
